...
def load_model():
    model = tf.keras.models.load_model('revised_base_model_v2.h5')
    return model
...
# Names Page
    ...
    st.markdown("---")
    st.write("- Fire Ant")
    fire_ant_image = load_image("https://drive.google.com/file/d/19lmNL-bp6w1_rgNr9FpvYFTdVgiJVBqA/view?usp=sharing")
    st.image(fire_ant_image, use_column_width=True)
    st.markdown("---")
    st.write("- Ghost Ant")
    ghost_ant_image = load_image("https://drive.google.com/file/d/1aiqzxD9Gcvu0IfbuHHTxH1KV39c7Mjmi/view?usp=sharing")
    st.image(ghost_ant_image, use_column_width=True)
    st.markdown("---")
    st.write("- Little Black Ant")
    little_black_ant_image = load_image("https://drive.google.com/file/d/1HmuG4nCDJqyzg1s3GkE5iOLpaeepBRRz/view?usp=sharing")
    st.image(little_black_ant_image, use_column_width=True)
    st.markdown("---")
    st.write("- Weaver Ant")
    weaver_ant_image = load_image("https://drive.google.com/file/d/175_7xb2XjpIST18YsEeCYQBPorCAisX3/view?usp=sharing")
...
# About Page
    ...
    st.markdown("---")
    st.header("Group 4 - CPE 027-CPE41S7")
    st.markdown("---")
    st.write("Beltran, Adrian David")
    st.write("Daiz, Chizel Angela")
    st.write("Darroca, Josiah Miguel")
    st.write("Roque, Jared Miguel")
    st.write("Zamora, Denzel")
    st.markdown("---")
    ...
    st.write("[Click Here](https://github.com/TddyJ/CPE027---CPE41S7---Group-4---Project.git)")
    st.header("Google Drive Link")
    st.write("[Click Here](https://drive.google.com/drive/folders/1anerDLviQcYy5dAXY5aZjW33cCKlOqt0?usp=sharing)")
    st.header("Sample Images for Testing")
    st.write("[Click Here](https://drive.google.com/drive/folders/11GOprOKBTPRb9puhWjHUsbKTBnpvg3AD?usp=sharing)")